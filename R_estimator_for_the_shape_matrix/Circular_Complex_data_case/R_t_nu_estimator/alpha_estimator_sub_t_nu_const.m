function alpha_est = alpha_estimator_sub_t_nu_const(y, T, nu, pert)
...
[Delta_T_1, KK_1] = Delta_Psi_eval_t_nu_const_11(y, T, nu);

% Evaluation of the perturbed approximation of the efficient central sequence Delta_T
T = T/T(1,1);
T_pert = T + V/sqrt(n);

Delta_T_1_pert = Delta_only_eval_t_nu_const_11(y, T_pert, nu);
