function [Delta_T, inv_Psi_T] = Delta_Psi_eval_vdW_const(y, T, U_c)
...
% Evaluation of the matrix "uncostrained" matrx K_V
inv_sr_T2 = kron(inv_sr_T.',inv_sr_T);
I_m = eye(m);
J_m_per = eye(m^2) - I_m(:)*I_m(:).'/m;
K_V = inv_sr_T2*J_m_per;
